        ...
        <section class="col-lg-8">
            <div class="card" style="width: 35rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="#" class="card-link"> <img src="../../img/Material Icons_e412(0)_48.png" alt="" srcset=""> Modifier photo de profil</a>
                </div>
            </div>
        </section>
        <div class="col-lg-2">
            <div class="row">
                <aside class="col-lg-12">
                    <ul class="list-group">
                        ...
                        <li class="h6 list-group-item"><a href="se_connecter.php">Se déconnecter</a></li>
                    </ul>
                </aside>
                <aside class="col-lg-12">
                    <!-- Aside -->
